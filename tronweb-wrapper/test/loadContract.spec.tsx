...
describe('loadContract', () => {
  ...
  it('Wallet installed loadContract', async () => {
    (window as any).tronWebs = await tronWebInstall()
  ...
  it('Wallet installed contract-call', async () => {
    ...
    let resultContract = await (window as any).tronWebs.contract(ERC20, 'TQaYBj9drxmoW7LfLnDDrvPnuj4zoZbaSS')
  ...
  it('Wallet installed contract-send', async () => {
    ...
    let Action = await new Actions()
    let Contract = await Action.actions.loadContract(ERC20, 'TQaYBj9drxmoW7LfLnDDrvPnuj4zoZbaSS');
    let contractSend: any = await Action.contract.onChainCall(Contract.data, 'approve', ['TQaYBj9drxmoW7LfLnDDrvPnuj4zoZbaSS', '0'], { gasPrice: '4000000000', gasLimit: '150000' })
  ...
  it('Wallet not installed contract-send', async () => {
    ...
    let Action = await new Actions();
    let Contract = await Action.actions.loadContract(ERC20, 'TQaYBj9drxmoW7LfLnDDrvPnuj4zoZbaSS');
    let contractSend: any = await Action.contract.onChainCall(Contract.data, 'approves', ['TQaYBj9drxmoW7LfLnDDrvPnuj4zoZbaSS', '0'], { gasPrice: '4000000000', gasLimit: '150000' })
